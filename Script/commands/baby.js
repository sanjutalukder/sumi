...
module.exports.handleEvent = async function ({ api, event, Users }) {
 ...
 if (
 raw.startsWith("baby ") || raw.startsWith("sumu ") || raw.startsWith("bby ") ||
 raw.startsWith("Sumu ") || raw.startsWith("xan ") ||
 raw.startsWith("জান ") || raw.startsWith("বট ") || raw.startsWith("বেবি ")
 ) {
 const query = raw
 .replace(/^baby\s+|^sumu\s+|^bby\s+|^Sumu\s+|^xan\s+|^জান\s+|^বট\s+|^বেবি\s+/i, "")
 .trim();
 if (!query) return;
