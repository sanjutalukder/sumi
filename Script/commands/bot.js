...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "bot") || (event.body.toLowerCase() == "bot")) {
     return api.sendMessage("bot কমান্ড এড় নাই টাইপ করুন baby", threadID);
   };
  
   if ((event.body.toLowerCase() == "@রি'সু") || (event.body.toLowerCase() == "@রি'সু") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("kiree ato boss k dakis kn valo talo basis naki", threadID);
   };

   if ((event.body.toLowerCase() == "Risu") || (event.body.toLowerCase() == "risu")) {
     return api.sendMessage("boss k na deke amak bol ki hoise ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tor bll") || (event.body.toLowerCase() == "bll")) {
     return api.sendMessage("~ koi dekhi jan tumr bal koto tuku hoise?? 🤖", threadID);
   };

  if ((event.body.toLowerCase() == "Risu") || (event.body.toLowerCase() == "Risu vai") || (event.body.toLowerCase() == "risu") || (event.body.toLowerCase() == "risu Vaiya")) {
     return api.sendMessage("উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "Owner") || (event.body.toLowerCase() == "bot admin")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Risu ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 risu.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61577317644701\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "Admin ke ")) {
     return api.sendMessage("My Creator: Risu ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস risu আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is risu ッ❤️ তাকে সবাই risu নামে  চিনে🤙", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "cup") || (event.body.toLowerCase() == "চুপ কর") || (event.body.toLowerCase() == "chup kor")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sali ami tor jamai") || (event.body.toLowerCase() == "sali ami risu") || (event.body.toLowerCase() == "chup ami risu") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস risu এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Farhana") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস risu এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "nam ki tumr")) {
     return api.sendMessage("️MY NAME IS °_>Sumu 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁", threadID);
   };

   if ((event.body.toLowerCase() == "BOT ER BACCHA") || (event.body.toLowerCase() == "Bot er bacca")) {
     return api.sendMessage("️আমার creator risur bacca তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️🌶️ ", threadID);
   };
  ...
  if (event.body.indexOf("Kiree") == 0 || (event.body.indexOf("kiree") == 0)) {
    var msg = {
      body: `${name}, ${rand}`
    }
