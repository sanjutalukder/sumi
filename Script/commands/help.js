...
const text = `╭──────•◈•──────╮\n│𝗨𝘀𝗲 ${prefix}help [Name?]\n│𝗨𝘀𝗲 ${prefix}help [Page?]\n│𝗡𝗔𝗠𝗘 𝗢𝗪𝗡𝗘𝗥 : │ 𝐑𝐈 𝐒𝐔 ッ\n│𝗧𝗢𝗧𝗔𝗟 : [${arrayInfo.length}]\n│📛🄿🄰🄶🄴📛 :  [${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}]\n╰──────•◈•──────╯`; 
    var link = [
"https://drive.google.com/uc?export=download&id=1YVDEppo_J-bIFULWqcrqlHSf4jHLi2y3", "https://drive.google.com/uc?export=download&id=1YVDEppo_J-bIFULWqcrqlHSf4jHLi2y3", "https://drive.google.com/uc?export=download&id=1YVDEppo_J-bIFULWqcrqlHSf4jHLi2y3", "https://i.postimg.cc/QdgH08j6/Messenger-creation-C2-A39-DCF-A8-E7-4-FC7-8715-2559476-FEEF4.gif",
"https://drive.google.com/uc?export=download&id=1YVDEppo_J-bIFULWqcrqlHSf4jHLi2y3",
"https://drive.google.com/uc?export=download&id=1YVDEppo_J-bIFULWqcrqlHSf4jHLi2y3",
"https://drive.google.com/uc?export=download&id=1YVDEppo_J-bIFULWqcrqlHSf4jHLi2y3",
    ]
